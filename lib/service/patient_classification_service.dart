...
class PatientClassificationService {
  ...
  Future<PatientClassificationModel> create(PatientClassificationModel classification) async {
    final SigV4Request signedRequest = this.awsCognitoService.getSigV4Request('POST', path, body: classification.toJson(true));
