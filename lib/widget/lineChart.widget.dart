...
enum LineChartTypeWidget { ANNUAL, MONTHLY }

class LineChartDimWidget {
  final double minX;
  final double maxX;
  final double minY;
  final double maxY;
...
class LineChartWidget extends StatefulWidget {
  ...
  final LineChartTypeWidget type;
  final LineChartDimWidget dimensions;

  LineChartWidget({this.data, this.type, this.dimensions});

  @override
  _LineChartWidgetState createState() => _LineChartWidgetState();
}

class _LineChartWidgetState extends State<LineChartWidget> with DateTimeUtil {
      ...
      titlesData: FlTitlesData(
        ...
        bottomTitles: SideTitles(
          ...
          getTextStyles: (value) => TextStyle(
              ...
              fontSize: 8),
          getTitles: (value) => (this.widget.type == LineChartTypeWidget.ANNUAL)
        ...
        LineChartBarData(
          spots: this
              ...
              .map((SerelizationDataUtil e) =>
                  e.createSpot(this.widget.type == LineChartTypeWidget.ANNUAL))
              .toList(),
          isCurved: true,
