...
class AwsAdapter {
  AwsAdapter._privateConstructor();
  static final AwsAdapter instance = AwsAdapter._privateConstructor();
  ...
  Future<bool> changePassword(
    ...
    return await cognitoUser.confirmPassword(
      code,
      newPassword,
    );
  }
