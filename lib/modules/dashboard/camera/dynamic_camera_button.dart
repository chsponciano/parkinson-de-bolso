...
class DynamicCameraButton extends StatefulWidget {
  ...
  const DynamicCameraButton({Key key, @required this.countDownController, this.tooltip, this.backgroundColor, this.icon, this.onPressed, this.companionLabel, this.onStart, this.onComplete, this.isLoading = false}) : super(key: key);
